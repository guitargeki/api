...
SELECT
    ...
    NULL::character varying(50) AS match_type_title,
    NULL::integer AS match_status_id,
    NULL::character varying(50) AS match_status_title;
...
SELECT
    ...
    NULL::character varying(32) AS winner_username,
    NULL::real AS winner_new_elo,
    NULL::real AS winner_old_elo,
    NULL::integer AS loser_id,
    NULL::character varying(32) AS loser_username,
...
SELECT
    ...
    NULL::character varying(32) AS participant_username,
    NULL::integer AS series_id,
    NULL::character varying(200) AS series_title,
    NULL::character varying(200) AS title,
...
4	6	8	1446.34473	1424	4	1377.65527	1400	2019-01-15 04:31:04.606
5	7	8	1468.79895	1446.33997	10	1401.54102	1424	2019-01-21 08:08:03.992
6	8	8	1488.10864	1468.80005	5	1380.69141	1400	2019-01-30 08:09:45.441
7	9	8	1504.62378	1488.10999	9	1359.48621	1376	2019-02-05 08:16:21.69
8	10	12	1401.65527	1376	13	1374.34473	1400	2019-02-07 03:02:07.901
9	11	8	1520.40466	1504.62	5	1364.90527	1380.68994	2019-02-10 23:35:59.729
10	12	7	1446.34473	1424	14	1377.65527	1400	2019-02-11 11:15:50.032
11	13	8	1536.40076	1520.40002	15	1383.99927	1400	2019-02-11 17:22:04.825
12	14	12	1425.54529	1401.66003	16	1376.11462	1400	2019-02-15 05:43:48.418
13	15	8	1550.13892	1536.40002	14	1363.92114	1377.66003	2019-02-17 19:18:33.791
14	16	8	1564.45837	1550.14001	10	1387.22168	1401.54004	2019-02-23 22:23:59.635
15	18	8	1577.8783	1564.45996	17	1386.58167	1400	2019-03-01 10:40:57.906
16	19	18	1424	1400	19	1376	1400	2019-03-27 06:48:42.329
17	21	12	1446.91296	1425.55005	10	1365.85706	1387.21997	2019-04-24 06:31:14.584
18	20	8	1589.32312	1577.88	16	1364.66687	1376.10999	2019-04-27 05:27:52.107
20	23	10	1389.42004	1365.85999	9	1335.92993	1359.48999	2019-04-29 04:13:21.579
19	25	8	1601.39941	1589.31995	21	1387.92065	1400	2019-05-02 02:36:31.361
21	24	9	1364.30627	1335.93005	22	1371.62366	1400	2019-05-09 06:17:38.743
22	26	20	1423.26941	1400	10	1366.15063	1389.42004	2019-05-09 07:05:08.019
...
CREATE OR REPLACE VIEW geki_view.participants AS
 SELECT participants.id,
    ...
    count(
        CASE
            WHEN ((participants.id = ranked_results.winner_id) OR (participants.id = ranked_results.loser_id)) THEN 1
            ELSE NULL::integer
        END) AS ranked_battles,
    count(
        CASE participants.id
            WHEN ranked_results.winner_id THEN 1
            ELSE NULL::integer
        END) AS wins,
    count(
        CASE participants.id
            WHEN ranked_results.loser_id THEN 1
            ELSE NULL::integer
        END) AS losses
...
CREATE OR REPLACE VIEW geki_view.ranked_results AS
 SELECT ranked_results.id,
   ...
   FROM (((geki_data.ranked_results
     ...
     LEFT JOIN geki_data.participants p2 ON ((ranked_results.loser_id = p2.id)))
