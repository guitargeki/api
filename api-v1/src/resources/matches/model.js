...
schema.input = {
    ...
    score_scale: Joi.number().integer(),
    event_id: customJoi.id().foreignKey(eventModel.tableName),
    match_type_id: customJoi.id().foreignKey(matchTypeModel.tableName),
    match_status_id: customJoi.id().foreignKey(matchStatusModel.tableName),
